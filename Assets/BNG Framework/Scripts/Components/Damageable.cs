...
namespace BNG {
    ...
    public class Damageable : MonoBehaviour {
        ...
        public UnityEvent<string, string> onDestroyed;
        ...
        private void Start() {
            ...
            ////look for AG1M
            if (AG1Manager.Instance != null)
            {
                onDestroyed.AddListener(AG1Manager.Instance.ConvertToNumber);
            }
            else
            {
                //Debug.LogError("<AG1Manager instance is not found at runtime.");
            }
        }
        ...
        public virtual void DestroyThis() {
            ...
            if (onDestroyed != null) {
                onDestroyed.Invoke(gameObject.name,gameObject.tag);
            }
